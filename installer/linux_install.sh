...
cp "./maxdomeII.ui" "$TheSkyX_Path/Resources/Common/PlugIns/DomePlugIns/"
cp "./libmaxdomeII.so" "$TheSkyX_Path/Resources/Common/PlugIns/DomePlugIns/"
...
if [ ! -z "$app_owner" ]; then
	...
	chown $app_owner "$TheSkyX_Path/Resources/Common/PlugIns/DomePlugIns/maxdomeII.ui"
	chown $app_owner "$TheSkyX_Path/Resources/Common/PlugIns/DomePlugIns/libmaxdomeII.so"
fi
chmod  755 "$TheSkyX_Path/Resources/Common/PlugIns/DomePlugIns/libmaxdomeII.so"
